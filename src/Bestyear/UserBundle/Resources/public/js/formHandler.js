 ...
 * It deals with the left arrow (moving up and down), the color of the circles (throw different classes) and the display of the right content
...
function checkAddress1onSubmit() {
    ...
    if ((streetnumber1.val() || street1.val() || postcode1.val() || city1.val() || addressmore1.val()) && !(streetnumber1.val() && street1.val() && postcode1.val() && city1.val())) {
...
function checkAddress2onSubmit() {
    ...
    // If one input is filled, they should all be filled
    if ((streetnumber2.val() || street2.val() || (postcode2.val() && postcode2.val() != "60200" || addressmore2.val()) || (city2.val()) && city2.val() != "Compiègne") && !(streetnumber2.val() && street2.val() && postcode2.val() && city2.val())) {
